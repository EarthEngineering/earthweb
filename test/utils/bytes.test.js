...
describe("EarthWeb.utils.bytes", function() {
    describe("#byte2hexStr()", function() {
        it("should convert a byte to a hex string", async function() {
            ...
            assert.equal(earthWeb.utils.bytes.byte2hexStr(21), "15");
            assert.equal(earthWeb.utils.bytes.byte2hexStr(33), "21");
            assert.equal(earthWeb.utils.bytes.byte2hexStr(78), "4E");
            assert.equal(earthWeb.utils.bytes.byte2hexStr(156), "9C");
            assert.equal(earthWeb.utils.bytes.byte2hexStr(200), "C8");
        });
        ...
        it("should throw if something else than a byte is passed as input", async function() {
            ...
            assert.throws(() => {
                earthWeb.utils.bytes.byte2hexStr("15");
            ...
            assert.throws(() => {
                earthWeb.utils.bytes.byte2hexStr(1455);
            }, "Input must be a byte");
        });
    });
    ...
    describe("#bytesToString()", function() {
        it("should convert an array of bytes to a hex string", async function() {
            ...
            assert.equal(
                earthWeb.utils.bytes.bytesToString([78, 112, 87, 69, 99, 65]),
                "NpWEcA"
            );
        ...
        it("should return the input if the input is a string", async function() {
            ...
            assert.equal(
                earthWeb.utils.bytes.bytesToString("NpWEcA"),
                "NpWEcA"
            );

            assert.equal(earthWeb.utils.bytes.bytesToString("Қࡀпω"), "Қࡀпω");
        });
    });
    ...
    describe("#hextoString()", function() {
        it("should convert an hex string to a utf-8 string", async function() {
            ...
            assert.equal(
                earthWeb.utils.bytes.hextoString("af43ed56aa77"),
                "¯CíVªw"
            );
            assert.equal(earthWeb.utils.bytes.hextoString("0xaf43"), "¯C");
            assert.equal(
                earthWeb.utils.bytes.hextoString(
    ...
    describe("#byteArray2hexStr()", function() {
        it("should convert an array of bytes to a hex string", async function() {
            ...
            assert.equal(
                earthWeb.utils.bytes.byteArray2hexStr([
                    73,
                    32,
                    108,
                    111,
        ...
        it("should throw if the array of bytes is not valid", async function() {
            ...
            assert.throws(() => {
                earthWeb.utils.bytes.byteArray2hexStr([73, -32, 108]);
            }, "Input must be a byte");
        });
    });
    ...
    describe("#base64EncodeToString()", function() {
        it("should encode a bytes array to a base64 string", async function() {
            ...
            let result = earthWeb.utils.bytes.base64EncodeToString([
                73,
                32,
                108,
                111,
    ...
    describe("#base64DecodeFromString()", function() {
        it("should decode a base64 string", async function() {
            ...
            let result = earthWeb.utils.bytes.base64DecodeFromString(
                "SSBsb3ZlIGRhcmsgY29tZWRpZXM="
            );

            let string = earthWeb.utils.bytes.bytesToString(result);
