...
describe('EarthWeb.trx', function () {
    ...
    describe('#constructor()', function () {
        ...
        it('should have been set a full instance in earthWeb', function () {
            assert.instanceOf(earthWeb.trx, EarthWeb.Trx);
        });
    ...
    describe('#Account Test', function () {
        ...
        describe("#getAccount", async function () {
            ...
            it('should get account by hex or base58 address', async function () {
                ...
                for (let type of addressType) {
                    account = await earthWeb.trx.getAccount(accounts[type][idx]);
            ...
            it('should throw address is not valid error', async function () {
                await assertThrow(
                    earthWeb.trx.getAccount('notAnAddress'),
        ...
        describe("#getAccountById", async function () {
            ...
            it('should get confirmed account by id', async function () {
                this.timeout(20000);
                while (true) {
                    const account = await earthWeb.trx.getAccountById(accountId);
            ...
            it('should throw accountId is not valid error', async function () {
                ...
                for (let id of ids) {
                    await assertThrow(
                        earthWeb.trx.getAccountById(id),
        ...
        describe("#getAccountResources", async function () {
            ...
            it('should get account resource by hex or base58 address', async function () {
                ...
                let accountResource;
                for (let type of addressType) {
                    accountResource = await earthWeb.trx.getAccountResources(accounts[type][idx]);
            ...
            it('should throw address is not valid error', async function () {
                await assertThrow(
                    earthWeb.trx.getAccountResources('notAnAddress'),
                    'Invalid address provided'
                );
            });
        ...
        describe("#getBalance", async function () {
            ...
            it('should get balance by hex or base58 address', async function () {
                ...
                let balance;
                for (let type of addressType) {
                    balance = await earthWeb.trx.getBalance(accounts[type][idx]);
        ...
        describe("#getBandwidth", async function () {
            ...
            it('should get bandwith by hex or base58 address', async function () {
                ...
                let bp;
                for (let type of addressType) {
                    bp = await earthWeb.trx.getBandwidth(accounts[type][idx]);
                    assert.isTrue(bp >= 0);
                }
            });
        ...
        describe("#getUnconfirmedAccount", async function () {
            ...
            it('should get unconfirmed account by address', async function () {
                const account = await earthWeb.trx.getUnconfirmedAccount(toHex);
                assert.equal(account.address, toHex.toLowerCase());
            });

            it('should throw address is not valid error', async function () {
                await assertThrow(
                    earthWeb.trx.getUnconfirmedAccount('notAnAddress'),
                    'Invalid address provided'
                );
            });
        ...
        describe("#geUnconfirmedAccountById", async function () {
            ...
            it('should get unconfirmed account by id', async function () {
                ...
                const account = await earthWeb.trx.getUnconfirmedAccountById(accountId);
                assert.equal(account.account_id, accountId.slice(2));
            });
            ...
            it('should throw accountId is not valid error', async function () {
                ...
                for (let id of ids) {
                    await assertThrow(
                        earthWeb.trx.getUnconfirmedAccountById(id),
                        'Invalid accountId provided'
                    );
                }
            });
        ...
        describe("#getUnconfirmedBalance", async function () {
            ...
            it('should get unconfirmed balance by account address', async function () {
                const balance = await earthWeb.trx.getUnconfirmedBalance(toHex);
        ...
        describe("#updateAccount", async function () {
            ...
            it('should update account name', async function () {
                ...
                await earthWeb.trx.updateAccount(accountName, { privateKey: accounts.pks[idx], address: accounts.hex[idx] });
                const account = await earthWeb.trx.getUnconfirmedAccount(accounts.hex[idx]);
                assert.equal(earthWeb.toUtf8(account.account_name), accountName);
            });

            it('should throw name must be a string error', async function () {
                await assertThrow(
                    earthWeb.trx.updateAccount({}),
    ...
    describe('#Sign Test', function () {
        ...
        describe("#sign", async function () {
            ...
            it('should sign a transaction', async function () {
                const signedTransaction = await earthWeb.trx.sign(transaction, accounts.pks[idx]);
            ...
            it('should throw transaction not valid error', async function () {
                await assertThrow(
                    earthWeb.trx.sign(undefined, accounts.pks[idx]),
            ...
            it('should throw transaction is already signed error', async function () {
                const signedTransaction = await earthWeb.trx.sign(transaction, accounts.pks[idx]);
                await assertThrow(
                    earthWeb.trx.sign(signedTransaction, accounts.pks[idx]),
            ...
            it('should throw private key does not match address error', async function () {
                await assertThrow(
                    earthWeb.trx.sign(transaction, accounts.pks[idx]),
        ...
        describe("#signMessage", async function () {
            ...
            it('should sign a hex string message', async function () {
                ...
                const signedMsg = await earthWeb.trx.sign(hexMsg, accounts.pks[idx]);
            ...
            it('should throw expected hex message input error', async function () {
                ...
                await assertThrow(
                    earthWeb.trx.sign(hexMsg, accounts.pks[idx]),
                    'Private key does not match address in transaction'
                );
            });
        ...
        describe("#verifyMessage", async function () {
            ...
            before(async function() {
                ...
                signedMsg = await earthWeb.trx.sign(hexMsg, accounts.pks[idx], null, false);
            });

            it('should verify signature of signed string message', async function () {
                const result = await earthWeb.trx.verifyMessage(hexMsg, signedMsg, accounts.hex[idx], null);
                assert.isTrue(result);
            });

            it('should throw expected hex message input error', async function () {
                await assertThrow(
                    earthWeb.trx.verifyMessage('e66f4c8f323229131006ad3e4a2ca65dfdf339f0', signedMsg, accounts.hex[idx], null),
            ...
            it('should throw signature does not match error', async function () {
                ...
                await assertThrow(
                    earthWeb.trx.verifyMessage(hexMsg, fakeSig, accounts.hex[idx], null),
        ...
        describe("#multiSignTransaction", async function () {
            ...
            before(async function() {
                ...
                const signedUpdateTransaction = await earthWeb.trx.sign(updateTransaction, ownerPk, null, false);
                await earthWeb.trx.broadcast(signedUpdateTransaction);
            ...
            it('should multi-sign a transaction by owner permission', async function () {
                ...
                for (let i = idxS; i < idxE; i++) {
                    signedTransaction = await earthWeb.trx.multiSign(signedTransaction, accounts.pks[i], 0);
                }

                assert.equal(signedTransaction.signature.length, 3);

                // broadcast multi-sign transaction
                const result = await earthWeb.trx.broadcast(signedTransaction);
            ...
            it('should multi-sign a transaction by owner permission (permission id inside tx)', async function () {
                ...
                let signedTransaction = transaction;
                for (let i = idxS; i < idxE; i++) {
                    signedTransaction = await earthWeb.trx.multiSign(signedTransaction, accounts.pks[i]);
                }
            ...
            it('should verify weight after multi-sign by owner permission', async function () {
                ...
                for (let i = idxS; i < idxE; i++) {
                    signedTransaction = await earthWeb.trx.multiSign(signedTransaction, accounts.pks[i], 0);
                    signWeight = await earthWeb.trx.getSignWeight(signedTransaction);
                    if (i < idxE - 1) {
                ...
                // get approved list
                const approvedList = await earthWeb.trx.getApprovedList(signedTransaction);
            ...
            it('should multi-sign a transaction with no permission error by owner permission', async function () {
                ...
                const transaction = await earthWeb.transactionBuilder.freezeBalance(10e5, 3, 'BANDWIDTH', accounts.b58[ownerIdx]);
                try {
                    await earthWeb.trx.multiSign(transaction, (accounts.pks[ownerIdx] + '123'), 0);
                } catch (e) {
            ...
            it('should multi-sign duplicated a transaction by owner permission', async function () {
                ...
                const transaction = await earthWeb.transactionBuilder.freezeBalance(10e5, 3, 'BANDWIDTH', accounts.b58[ownerIdx]);
                try {
                    let signedTransaction = await earthWeb.trx.multiSign(transaction, accounts.pks[ownerIdx], 0);
                    await earthWeb.trx.multiSign(signedTransaction, accounts.pks[ownerIdx], 0);
                } catch (e) {
            ...
            it('should multi-sign a transaction by active permission', async function () {
                ...
                let signedTransaction = transaction;
                for (let i = idxS; i < idxE; i++) {
                    signedTransaction = await earthWeb.trx.multiSign(signedTransaction, accounts.pks[i], 2);
                }
            ...
            it('should verify weight after multi-sign by active permission', async function () {
                ...
                for (let i = idxS; i < idxE; i++) {
                    signedTransaction = await earthWeb.trx.multiSign(signedTransaction, accounts.pks[i], 2);
                    signWeight = await earthWeb.trx.getSignWeight(signedTransaction, 2);
                    if (i < idxE - 1) {
                        assert.equal(signWeight.result.code, 'NOT_ENOUGH_PERMISSION');
                    }
                    assert.equal(signWeight.approved_list.length, i - idxS + 1);
            ...
            it('should multi-sign a transaction with no permission error by active permission', async function () {
                ...
                const transaction = await earthWeb.transactionBuilder.freezeBalance(10e5, 3, 'BANDWIDTH', accounts.b58[ownerIdx]);
                try {
                    await earthWeb.trx.multiSign(transaction, (accounts.pks[ownerIdx] + '123'), 2);
                } catch (e) {
                    assert.isTrue(e.indexOf('has no permission to sign') != -1);
                }
            ...
            it('should multi-sign duplicated a transaction by active permission', async function () {
                ...
                const transaction = await earthWeb.transactionBuilder.freezeBalance(10e5, 3, 'BANDWIDTH', accounts.b58[ownerIdx]);
                try {
                    let signedTransaction = await earthWeb.trx.multiSign(transaction, accounts.pks[ownerIdx], 2);
                    await earthWeb.trx.multiSign(signedTransaction, accounts.pks[ownerIdx], 2);
                } catch (e) {
                    assert.isTrue(e.indexOf('already sign transaction') != -1);
                }
            ...
            it('should multi-sign a transaction with wrong permission id error', async function () {
                ...
                try {
                    const transaction = await earthWeb.transactionBuilder.freezeBalance(10e5, 3, 'BANDWIDTH', accounts.b58[ownerIdx]);
                    await earthWeb.trx.multiSign(transaction, accounts.pks[ownerIdx], 1);
                } catch (e) {
    ...
    describe('#Block Test', function () {
        ...
        describe("#getBlock", async function () {
            ...
            it('should get earliest or latest block', async function () {
                ...
                for (let type of blockType) {
                    block = await earthWeb.trx.getBlock(type);
                    if (type === 'earliest') {
        ...
        describe("#getBlockByHash", async function () {
            ...
            it('should get block by block hash (id)', async function () {
                const block = await earthWeb.trx.getBlock('latest');
                const blockByHash = await earthWeb.trx.getBlockByHash(block.blockID);
        ...
        describe("#getBlockByNumber", async function () {
            ...
            it('should get block by block number', async function () {
                const block = await earthWeb.trx.getBlock('latest');
                const blockByNumber = await earthWeb.trx.getBlockByNumber(block.block_header.raw_data.number);
        ...
        describe("#getBlockRange", async function () {
            ...
            it('should get block by range', async function () {
                const blocks = await earthWeb.trx.getBlockRange(0, 5);
            ...
            it('should get invalid start or end error by range', async function () {
                ...
                for (let range of ranges) {
                    await assertThrow(
                        earthWeb.trx.getBlockRange(range[0], range[1]),
        ...
        describe("#getBlockTransactionCount", async function () {
            ...
            it('should get transaction count by block number, \'latest\' or \'earliest\'', async function () {
                ...
                for (let type of blockType) {
                    const count = await earthWeb.trx.getBlockTransactionCount(type);
        ...
        describe("#getCurrentBlock", async function () {
            ...
            it('should get current block', async function () {
                const block = await earthWeb.trx.getCurrentBlock();
                assert.isNumber(block.block_header.raw_data.number);
            });
    ...
    describe('#Transaction Test', function () {
        ...
        describe("#send", async function () {
            ...
            it('should send trx', async function () {
                ...
                const balanceBefore = await earthWeb.trx.getUnconfirmedBalance(accounts.hex[toIdx]);
                await earthWeb.trx.send(accounts.hex[toIdx], 10e5, { privateKey: accounts.pks[fromIdx], address: accounts.hex[fromIdx] });
                await waitChainData('balance', accounts.hex[toIdx], balanceBefore);
                const balanceAfter = await earthWeb.trx.getUnconfirmedBalance(accounts.hex[toIdx]);
                assert.equal(balanceAfter - balanceBefore, 10e5);
            });

            it('should throw invalid recipient provided error', async function () {
                await assertThrow(
                    earthWeb.trx.send('notValidAddress', 10e5, { privateKey: accounts.pks[fromIdx] }),
            ...
            it('should throw invalid amount provided error', async function () {
                await assertThrow(
                    earthWeb.trx.send(accounts.hex[toIdx], -1, { privateKey: accounts.pks[fromIdx] }),
        ...
        describe("#sendTransaction", async function () {
            ...
            it('should send trx', async function () {
                ...
                const balanceBefore = await earthWeb.trx.getUnconfirmedBalance(accounts.hex[toIdx]);
                await earthWeb.trx.sendTransaction(accounts.hex[toIdx], 10e5, { privateKey: accounts.pks[fromIdx] });
                await waitChainData('balance', accounts.hex[toIdx], balanceBefore);
                const balanceAfter = await earthWeb.trx.getUnconfirmedBalance(accounts.hex[toIdx]);
                assert.equal(balanceAfter - balanceBefore, 10e5);
            });
            ...
            it('should throw invalid recipient provided error', async function () {
                await assertThrow(
                    earthWeb.trx.sendTransaction('notValidAddress', 10e5, { privateKey: accounts.pks[fromIdx] }),
                    'Invalid recipient provided'
                );
            });
            ...
            it('should throw invalid amount provided error', async function () {
                await assertThrow(
                    earthWeb.trx.sendTransaction(accounts.hex[toIdx], -1, { privateKey: accounts.pks[fromIdx] }),
                    'Invalid amount provided'
                );
            });
        ...
        describe("#sendTrx", async function () {
            ...
            it('should send trx', async function () {
                ...
                const balanceBefore = await earthWeb.trx.getUnconfirmedBalance(accounts.hex[toIdx]);
                await earthWeb.trx.sendTrx(accounts.hex[toIdx], 10e5, { privateKey: accounts.pks[fromIdx], address: accounts.hex[fromIdx] });
                await waitChainData('balance', accounts.hex[toIdx], balanceBefore);
                const balanceAfter = await earthWeb.trx.getUnconfirmedBalance(accounts.hex[toIdx]);
                assert.equal(balanceAfter - balanceBefore, 10e5);
            });
            ...
            it('should throw invalid recipient provided error', async function () {
                await assertThrow(
                    earthWeb.trx.sendTrx('notValidAddress', 10e5, { privateKey: accounts.pks[fromIdx] }),
                    'Invalid recipient provided'
                );
            });
            ...
            it('should throw invalid amount provided error', async function () {
                await assertThrow(
                    earthWeb.trx.sendTrx(accounts.hex[18], -1, { privateKey: accounts.pks[fromIdx] }),
                    'Invalid amount provided'
                );
            });
        ...
        describe("#freezeBalance", async function () {
            ...
            it('should freeze balance for energy or bandwidth', async function () {
                ...
                let accountBefore = await earthWeb.trx.getAccount(accounts.hex[idx]);
                await earthWeb.trx.freezeBalance(10e5, 3, 'BANDWIDTH', { privateKey: accounts.pks[idx], address: accounts.hex[idx] });
                await waitChainData('freezeBp', accounts.hex[idx], 0);
                let accountAfter = await earthWeb.trx.getUnconfirmedAccount(accounts.hex[idx]);
                ...
                await earthWeb.trx.freezeBalance(10e5, 3, 'ENERGY', { privateKey: accounts.pks[idx], address: accounts.hex[idx] });
                await waitChainData('freezeEnergy', accounts.hex[idx], 0);
                accountAfter = await earthWeb.trx.getUnconfirmedAccount(accounts.hex[idx]);
                assert.equal(
            ...
            it('should throw invalid resource provided: expected "BANDWIDTH" or "ENERGY" error', async function () {
                await assertThrow(
                    earthWeb.trx.freezeBalance(10e8, 3, 'GAS', { privateKey: accounts.pks[idx], address: accounts.hex[idx] }),
            ...
            it('should throw invalid amount provided error', async function () {
                await assertThrow(
                    earthWeb.trx.freezeBalance(-10, 3, 'BANDWIDTH', { privateKey: accounts.pks[idx], address: accounts.hex[idx] }),
                    'Invalid amount provided'
                );
            });
            ...
            it('should throw invalid duration provided, minimum of 3 days error', async function () {
                await assertThrow(
                    earthWeb.trx.freezeBalance(10e8, 2, 'BANDWIDTH', { privateKey: accounts.pks[idx], address: accounts.hex[idx] }),
        ...
        describe.skip("#unfreezeBalance", async function () {
            ...
            before(async function(){
                await earthWeb.trx.freezeBalance(10e5, 3, 'BANDWIDTH', {}, accounts.b58[15]);
                await earthWeb.trx.freezeBalance(10e5, 3, 'ENERGY', {}, accounts.b58[15]);
            });

            it('should unfreeze balance', async function () {
                let accountBefore = await earthWeb.trx.getUnconfirmedAccount(ADDRESS_HEX);
                await earthWeb.trx.unfreezeBalance('BANDWIDTH', {}, accounts.b58[15]);
                let accountAfter = await earthWeb.trx.getUnconfirmedAccount(ADDRESS_HEX);
                assert.equal(accountBefore.frozen[0].frozen_balance - 10e5, accountAfter.frozen[0].frozen_balance);

                accountBefore = accountAfter;
                await earthWeb.trx.unfreezeBalance('ENERGY', {}, accounts.b58[15]);
                accountAfter = await earthWeb.trx.getUnconfirmedAccount(ADDRESS_HEX);
                assert.equal(
                    accountBefore.account_resource.frozen_balance_for_energy.frozen_balance - 10e5,
                    accountAfter.account_resource.frozen_balance_for_energy.frozen_balance
                );
            ...
            it('should throw invalid resource provided: expected "BANDWIDTH" or "ENERGY" error', async function () {
                await assertThrow(
                    earthWeb.trx.unfreezeBalance(10e8, 3, 'GAS', {}, accounts.b58[15]),
                    'Invalid resource provided: Expected "BANDWIDTH" or "ENERGY"'
                );
            });
        ...
        */
        ...
        describe("#broadcast", async function () {
            ...
            before(async function () {
                transaction = await earthWeb.transactionBuilder.freezeBalance(10e5, 3, 'BANDWIDTH', accounts.b58[idx]);
                signedTransaction = await earthWeb.trx.sign(transaction, accounts.pks[idx]);
            });
            ...
            it('should throw invalid options provided error', async function () {
                await assertThrow(
                    earthWeb.trx.broadcast(signedTransaction, false),
            ...
            it('should throw transaction is not signed error', async function () {
                await assertThrow(
                    earthWeb.trx.broadcast(transaction),
        ...
        describe("#getTransaction", async function () {
            ...
            before(async function(){
                ...
                transaction = await earthWeb.trx.freezeBalance(10e5, 3, 'BANDWIDTH', { privateKey: accounts.pks[idx], address: accounts.hex[idx] });
                transaction = transaction.transaction;
                await waitChainData('tx', transaction.txID);
            });

            it('should get transaction by id', async function () {
                const tx = await earthWeb.trx.getTransaction(transaction.txID);
                assert.equal(tx.txID, transaction.txID);
            });

            it('should throw transaction not found error', async function () {
                await assertThrow(
                    earthWeb.trx.getTransaction('a8813981b1737d9caf7d51b200760a16c9cdbc826fa8de102386af898048cbe5'),
        ...
        describe("#getTransactionFromBlock", async function () {
            ...
            before(async function(){
                ...
                transaction = await earthWeb.trx.freezeBalance(10e5, 3, 'BANDWIDTH', { privateKey: accounts.pks[idx], address: accounts.hex[idx] });
                transaction = transaction.transaction;
                const currBlock = await earthWeb.trx.getBlock('latest');
            ...
            it('should get transaction from block', async function () {
                ...
                for (let i = currBlockNum; i < currBlockNum + 3;) {
                    try {
                        const tx = await earthWeb.trx.getTransactionFromBlock(i, 0);
                        // assert.equal(tx.txID, transaction.txID);
            ...
            it('should throw transaction not found error by transaction from block', async function () {
                await assertThrow(
                    earthWeb.trx.getTransactionFromBlock(currBlockNum - 1, 0),
            ...
            it('should throw block not found error by transaction from block', async function () {
                await assertThrow(
                    earthWeb.trx.getTransactionFromBlock(currBlockNum + 50, 0),
                    'Block not found'
                );
            });
            ...
            it('should throw invalid index error by transaction from block', async function () {
                await assertThrow(
                    earthWeb.trx.getTransactionFromBlock(currBlockNum, -1),
        ...
        describe("#geUnconfirmedTransactionInfo", async function () {
            ...
            before(async function(){
                transaction = (await earthWeb.trx.freezeBalance(10e5, 3, 'BANDWIDTH', { privateKey: accounts.pks[idx], address: accounts.hex[idx] })).transaction;
                await waitChainData('tx', transaction.txID);
            });
            ...
            it('should get unconfirmed transaction by id', async function () {
                this.timeout(10000)
                await wait(3)
                const tx = await earthWeb.trx.getUnconfirmedTransactionInfo(transaction.txID);
                assert.equal(tx.id, transaction.txID);
            });

            it('should throw transaction not found error', async function () {
                await assertThrow(
                    earthWeb.trx.getUnconfirmedTransactionInfo('a8813981b1737d9caf7d51b200760a16c9cdbc826fa8de102386af898048cbe5'),
                    'Transaction not found'
                );
            });
        ...
        describe("#getConfirmedTransaction", async function () {
            ...
            it('should get confirmed transaction by tx id', async function () {
                ...
                while (true) {
                    try {
                        const tx = await earthWeb.trx.getConfirmedTransaction(transaction.transaction.txID);
    ...
    describe('#Token Test', function () {
        ...
        describe("#sendAsset", async function () {
            ...
            before(async function(){
                ...
                token = await earthWeb.trx.getTokensIssuedByAddress(accounts.hex[fromIdx]);
            });

            it('should send trx by to address and verify account balance', async function () {
                this.timeout(20000);

                const assetBefore = (await earthWeb.trx.getUnconfirmedAccount(accounts.hex[toIdx])).assetV2;
                await waitChainData('tokenById', token[Object.keys(token)[0]]['id']);
                await earthWeb.trx.sendAsset(
                    accounts.hex[toIdx],
                    10e4,
                ...
                const assetAfter = (await earthWeb.trx.getUnconfirmedAccount(accounts.hex[toIdx])).assetV2;
                assert.equal(!assetBefore ? 0 : assetBefore[0].value, assetAfter[0].value - 10e4);
            });

            it('should throw invalid recipient provided error', async function () {
                await assertThrow(
                    earthWeb.trx.sendAsset(
                        'notValidAddress',
                        10e4,
                        token[Object.keys(token)[0]]['id'],
                        { privateKey: accounts.pks[fromIdx], address: accounts.hex[fromIdx] }
        ...
        describe("#getTokenFromID", async function () {
            ...
            it('should get token by name', async function () {
                const tokens = await earthWeb.trx.listTokens(5, 0);
                for (let token of tokens) {
                    const tk = await earthWeb.trx.getTokenFromID(token.id);
            ...
            it('should throw token does not exist error', async function () {
                await assertThrow(
                    earthWeb.trx.getTokenFromID(1234565),
        ...
        describe("#getTokensIssuedByAddress", async function () {
            ...
            it('should get token by issued address', async function () {
                const tokens = await earthWeb.trx.listTokens(5, 0);
                for (let token of tokens) {
                    const tk = await earthWeb.trx.getTokensIssuedByAddress(token.owner_address);
            ...
            it('should throw invalid address provided error', async function () {
                await assertThrow(
                    earthWeb.trx.getTokensIssuedByAddress('abcdefghijklmn'),
                    'Invalid address provided'
                );
            });
        ...
        describe("#listTokens", async function () {
            ...
            it('should list all tokens by limit', async function () {
                const tokens = await earthWeb.trx.listTokens(10, 0);
        ...
        describe("#parseToken", async function () {
            ...
            it('should list all tokens by limit', async function () {
                ...
                for (let token of tokens) {
                    ...
                    const tk = earthWeb.trx._parseToken(token);
    ...
    describe('#Exchange Test', function () {
        ...
        describe("#listExchanges", async function () {
            ...
            it('should get exchange by id', async function () {
                const exchanges = await earthWeb.trx.listExchanges();
        ...
        describe("#listExchangesPaginated", async function () {
            ...
            it('should get exchange by id', async function () {
                const exchanges = await earthWeb.trx.listExchangesPaginated(10, 0);
                assert.isArray(exchanges);
        ...
        describe("#getExchangeByID", async function () {
            ...
            before(async function(){
                ...
                exchanges = await earthWeb.trx.listExchanges();
            });

            it('should get exchange by id', async function () {
                for (let exchange of exchanges) {
                    const ex = await earthWeb.trx.getExchangeByID(exchange.exchange_id);
    ...
    describe("#Proposal Test", async function () {
        ...
        describe("#getChainParameters", async function () {
            ...
            it('should get proposal list', async function () {
                const params = await earthWeb.trx.getChainParameters();
        ...
        describe("#getProposal", async function () {
            ...
            it('should get proposal by id', async function () {
                for (let proposal of proposals) {
                    const ps = await earthWeb.trx.getProposal(proposal.proposal_id);
        ...
        describe("#listProposals", async function () {
            ...
            it('should list seeds node', async function () {
                const proposals = await earthWeb.trx.listProposals();
                for (let proposal of proposals) {
    ...
    describe("#getContract", async function () {
        ...
        it('should get contract by contract address', async function () {
            const contract = await earthWeb.trx.getContract(transaction.contract_address);
        ...
        it('should throw invalid contract address provided error', async function () {
            await assertThrow(
                earthWeb.trx.getContract('notAddress'),
        ...
        it('should throw contract does not exist error', async function () {
            await assertThrow(
                earthWeb.trx.getContract('417cbcc41052b59584d1ac9fc1ce39106533aa1d40'),
    ...
    describe("#listNodes", async function () {
        ...
        it('should list seeds node', async function () {
            const nodes = await earthWeb.trx.listNodes();
    ...
    describe("#listSuperRepresentatives", async function () {
        ...
        it('should list super representatives', async function () {
            const srs = await earthWeb.trx.listSuperRepresentatives();
            assert.isArray(srs);
            for (let sr of srs) {
    ...
    describe("#timeUntilNextVoteCycle", async function () {
        ...
        it('should get time util next vote cycle', async function () {
            const num = await earthWeb.trx.timeUntilNextVoteCycle();
            assert.isNumber(num);
        });
    ...
    describe("#getReward", async function () {
        it('should get the reward', async function () {
            ...
            let reward = await earthWeb.trx.getReward(accounts[0]);
    ...
    describe("#getUnconfirmedReward", async function () {
        it('should get the reward', async function () {
            ...
            let reward = await earthWeb.trx.getUnconfirmedReward(accounts[0]);
            assert.equal(reward, 0)
    ...
    describe("#getBrokerage", async function () {
        it('should get the brokerage', async function () {
            ...
            let brokerage = await earthWeb.trx.getBrokerage(accounts[0]);
    ...
    describe("#getUnconfirmedBrokerage", async function () {
        it('should get the brokerage', async function () {
            ...
            let brokerage = await earthWeb.trx.getUnconfirmedBrokerage(accounts[0]);
            assert.equal(brokerage, 20)
